...
lastModified: 2025-03-31T23:34:06-04:00
links:
...
The volume is approximated by a grid of tetrahedral elements. Each element is
represented by a non-linear stiffness function representing the fibers of the
material, in contrast with most other solvers that only offer linear materials.
