---
title: Invest with Code
description: Dynamic Portfolios Powered by Bayesian Strategies
links:
    website: https://invest-with-code.com/
tags: python, nextjs, react, Stripe API
---

## Goal

I built Invest with Code with two primary goals. First, to provide active investors with robust, intuitive market
